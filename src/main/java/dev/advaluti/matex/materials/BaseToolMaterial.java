...
public enum BaseToolMaterial implements IItemTier {
    ...
    COPPER(1, 170, 2.0F, 1.0F, 10, () -> Ingredient.fromItems(Registration.INGOTCOPPER.get())),
    TIN(1, 150, 2.0F, 1.0F, 15, () -> Ingredient.fromItems(Registration.INGOTTIN.get())),
    ...
    SILVER(2, 500, 5.0F, 1.5F, 22, () -> Ingredient.fromItems(Registration.INGOTSILVER.get())),
    ...
    TUNGSTEN(2, 450, 4.0F, 2.0F, 10, () -> Ingredient.fromItems(Registration.INGOTTUNGSTEN.get())),
    ...
    TITANIUM(2, 850, 4.0F, 2.5F, 10, () -> Ingredient.fromItems(Registration.INGOTTITANIUM.get())),
    ELECTRUM(2, 520, 9.0F, 1.5F, 22, () -> Ingredient.fromItems(Registration.INGOTELECTRUM.get())),
    ...
    STEEL(2, 750, 6.0F, 2.2F, 10, () -> Ingredient.fromItems(Registration.INGOTSTEEL.get())),
    BRONZE(2, 850, 7.5F, 2.0F, 12, () -> Ingredient.fromItems(Registration.INGOTBRONZE.get()));

            ...
            if(ConfigGeneral.enableOreGen.get()) {
                ...
                if(ConfigGeneral.enableAluminium.get()) {
                    ...
                    biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.withConfiguration(
                            new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, Registration.OREALUMINIUM.get().getDefaultState(), ConfigGeneral.VSAluminium.get())).withPlacement(AluminiumGen));
                }
